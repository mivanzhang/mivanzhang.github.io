...
* Decreased ANR rate of Kwai which has more than 40 million DAUs (the biggest competitor of TikTok in Brazil) from **1.2%** to **0.7%**. 
...
## TECHNICAL SKILLS
Proficient in *Java*, Also familiar with *Kotlin* and *shell*.